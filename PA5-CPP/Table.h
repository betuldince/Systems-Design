...
class Table {
 public:
   ...
   // PRE: key shouldn't contain any whitespace, value should be greater than 0.
   ...
   // returns th enumber of entries in the table
 ...
 private:
   ...
   // PRE: word shouldn't contain any whitespace, 
   ...
   // This pointer points to the elements in the Table.
   ListType *data;
